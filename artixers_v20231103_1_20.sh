...
function permisos_especiales {
    ...
    rojo;echo "" && echo "IMPORTANTE: debe poseer el paquete 'dialog' instalado para que esta sección funcione correctamente."
    echo "De no ser así, deberá instalar el paquete antes de proseguir." && echo ""; blanco
